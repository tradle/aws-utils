...
// interface PubKeyMapping {
//   link: string
//   pub: string
// }

// interface IdentitiesOpts {
//   db: DB
//   objects: Objects
//   storage: Storage
...
//   public getPubKeyMapping = async ({ pub, time }: { pub: string; time: number }) => {
...
//     const hasSigPubKey = (existing || identity).pubkeys.filter(isUpdateKey).find(({ pub }) => pub === sigPubKey.pub)
