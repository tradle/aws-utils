...
const prettify = obj => stringify(obj, null, 2)
  .replace(/(senderID: )(0|1|2)/g, (_, prefix, type) => {
    return prefix + 'SenderID.' + ((type === '0') ? 'Unavailable' : (type === '1') ? 'Available' : 'PreRequisitesRequired')
  })
...
async function main () {
  ...
  await fs.writeFile(`${__dirname}/../../packages/aws-common-utils/src/countries.ts`, `import { Country, SenderID } from './types'
